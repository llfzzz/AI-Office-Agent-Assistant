// Free Joy — vendored component subset.
// Imported from the "Free Joy Design System" claude.ai/design project via the
// design MCP. Components are plain ES-exported .jsx with co-located .d.ts types;
// they read the design tokens in ./tokens/*.css (loaded once in src/index.css).
